...
function buildSidebar()
    ...
    pcall(function()
        plusBtn:setHeight(34)
        plusBtn:setText('+')
        plusBtn:setFont('Verdana Bold-14px')
        plusBtn:setImageSource('')
        plusBtn:setBorderWidth(1)
        plusBtn:setBorderColor('#00B4D860')
        plusBtn:setPaddingLeft(14)
        plusBtn:setPaddingRight(14)
        plusBtn:setPaddingTop(6)
        plusBtn:setPaddingBottom(6)
